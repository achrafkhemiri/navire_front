...
export const APIS = [CamionControllerService, ChauffeurControllerService, ClientControllerService, DepotControllerService, ProjetClientControllerService, ProjetControllerService, UserControllerService, VoyageControllerService];
